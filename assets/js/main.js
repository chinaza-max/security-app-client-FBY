...
document.getElementById("jobType").addEventListener("change", function() {
  ...
  if(this.value=="Instant"){
      document.querySelectorAll(".subscribtionItem").forEach((ele)=>{
        ele.style.display="none";
      })

      document.querySelectorAll(".subscribtionItem2").forEach((ele)=>{
        ele.style.display="none";
      })

      document.querySelectorAll(".instantItem2").forEach((ele)=>{
        ele.style.display="block";
      })

      document.querySelectorAll(".instantItem").forEach((ele)=>{
